...
DATA_PATH='/home/qiaoan/data/TableBench'
SAVE_PATH='/home/qiaoan/Documents/WikiTableQuestions/eval_examples/inference_results'
MODEL_DIR='/home/qiaoan/data/Qwen2-7B-Instruct'
TOKENIZER_DIR='/home/qiaoan/data/Qwen2-7B-Instruct'

CUDA_LAUNCH_BLOCKING=1 python infer_original.py \
    --model_name_or_path $MODEL_DIR \
    --tokenizer_name_or_path $TOKENIZER_DIR \
    --dataset_path $DATA_PATH \
    --save_path $SAVE_PATH \
